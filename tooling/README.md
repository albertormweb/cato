...
They exist because two jobs should not rely on an LLM being honest with itself:
deriving the trust score from the audit log, and keeping portable rule copies in
sync. Structure tests catch silent instruction rot (stale tools, broken refs,
